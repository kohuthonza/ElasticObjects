...
void Display::Update(Camera &camera, vec3 &lightPosition, Sim &sim){
			...
			case SDL_KEYDOWN: {
				switch (e.key.keysym.sym) {
					...
					case SDLK_SPACE: {
						...
						sim.GetObjects().back()->InitOBJTest("obj_models\\sphere2.obj", 20.0f, 2000.0f, spherepos, camera.GetFwd() * 50.0f);
